...
export default function TutorialContent({ content }: TutorialContentProps) {
    // Efecto para aplicar estilos a los elementos del contenido después de renderizar
    useEffect(() => {
        // Puedes añadir cualquier manipulación del DOM aquí si es necesario
    }, []);
            ...
            <ReactMarkdown
                ...
                components={{
                    ...
                    blockquote: ({ node, ...props }) => (
                        <blockquote
                            className="border-l-4 border-neutral-300 dark:border-neutral-700 pl-4 italic my-4"
                            {...props}
                        />
                    ),
